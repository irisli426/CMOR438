...
### 3. Install `my_ml_package` in editable mode
...
Every algorithm in this source directory is validated against a corresponding test file in the `tests/` directory. Testing covers:
